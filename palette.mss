...
/* This is a harmonisation of data from the Government of Tanzania and 
 * publicy available data from OpenStreetMap. As such some data is (c)
...
/**
* Can be used to washout the land and sea.
* @land:              #fffffe;
* @water:             #eeffff;
*/
